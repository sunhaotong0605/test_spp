...
def decode(
    ...
    def get_logits(input_ids, inference_params):
        ...
        return next_token_logits[..., :vocab_size] if vocab_size is not None else next_token_logits
...
def update_graph_cache(
    ...
    if (
        ...
        assert hasattr(model,
                       "allocate_inference_cache"), "CUDA graph decoding requires that the model has a method allocate_inference_cache"
